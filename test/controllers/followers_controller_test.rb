...
class FollowersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follower" do
    assert_difference('Follower.count') do
      post followers_url, params: { follower: { follower_id: @follower.follower_id, modified_date: @follower.modified_date, user_id: @follower.user_id } }
    end
  ...
  test "should update follower" do
    patch follower_url(@follower), params: { follower: { follower_id: @follower.follower_id, modified_date: @follower.modified_date, user_id: @follower.user_id } }
